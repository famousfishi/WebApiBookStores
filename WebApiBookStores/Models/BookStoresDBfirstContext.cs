...
namespace WebApiBookStores.Models
{
    public partial class BookStoresDBfirstContext : DbContext
    {
        public BookStoresDBfirstContext()
        {
        }

        public BookStoresDBfirstContext(DbContextOptions<BookStoresDBfirstContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Publisher>(entity =>
            {
                entity.HasKey(e => e.PubId)
                    .HasName("PK__Publishe__2515F222E2E6B330");
